...
import com.rimi.kmangel.angeldoctor.bean.UpdateInfo;
...
import com.rimi.kmangel.angeldoctor.utils.JudgePushToken;
import com.rimi.kmangel.angeldoctor.utils.SPUtils;
import com.rimi.kmangel.angeldoctor.widget.ScrollbleViewPager;
        ...
        public void run() {
            boolean isUpdate = UpdateManager
                    .getUpdateInfo( GuideActivity.this,
                            "http://app.kmangel.com/checkversioncode.json",
                            true);
            if (isUpdate) {
